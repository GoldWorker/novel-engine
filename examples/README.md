...
Canonical runnable TypeScript for the **[host guide](../docs/guide.md)** ([中文](../docs/guide.zh-CN.md)). The root [README](../README.md) is the product hub; internals live in [architecture](../docs/architecture.md).

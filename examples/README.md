...
| [7. Host session](../README.md#scenario-session) | [`session-workspace.ts`](session-workspace.ts) (incl. [7.2a–7.2e](../README.md#scenario-session-impact) assess / apply) |
| [8. Session over Worker](../README.md#scenario-session-worker) | [`session.worker.ts`](session.worker.ts) + [`session-host.ts`](session-host.ts) (incl. [8.1](../README.md#scenario-session-worker-impact)) |
